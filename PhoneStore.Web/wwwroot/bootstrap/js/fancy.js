!(function (t, e) {
    ...
    Object.defineProperty(g, "version", { enumerable: !0, configurable: !0, writable: !0, value: "5.0.12" }), Object.defineProperty(g, "defaults", { enumerable: !0, configurable: !0, writable: !0, value: {} });
    class b extends g {
        constructor(t = {}) {
    ...
    class Y extends b {
        ...
        animate() {
            ...
            for (const e of k)
                this.friction
                    ? ((this.velocity[e] *= 1 - this.friction), t && !this.isScaling && (this.velocity[e] = Math.max(Math.min(this.velocity[e], t), -1 * t)), (this.current[e] += this.velocity[e]))
        ...
        onClick(t) {
            ...
            const c = (e) => {
                !this.option("zoom") ||
                    ...
                    (e && "string" == typeof e && /(iterateZoom)|(toggle(Zoom|Full|Cover|Max)|(zoomTo(Fit|Cover|Max)))/.test(e) && "function" == typeof this[e] && (t.preventDefault(), this[e]({ event: t })));
            },
        ...
        onPointerDown(t, e, i) {
            ...
            return (
                ...
                E(this.targetScale, 1e3) === E(this.minScale, 1e3) ? (this.stop(), (this.target.e = this.current.e), (this.target.f = this.current.f)) : this.stop("target"),
                (this.isDragging = !0),
        ...
        startDecelAnim() {
            ...
            if (((d < this.minScale - 1e-5 || d > this.maxScale + 1e-5) && (h = 0.35), o > 0)) {
            ...
            l && (a = l / (1 / (1 - h) - 1)),
                c && (r = c / (1 / (1 - h) - 1)),
                ("y" === this.option("lockAxis") || ("xy" === this.option("lockAxis") && "y" === this.lockedAxis && E(d) === this.minScale)) && (a = l = 0),
                ("x" === this.option("lockAxis") || ("xy" === this.option("lockAxis") && "x" === this.lockedAxis && E(d) === this.minScale)) && (r = c = 0);
            const u = this.dragOffset.x,
                p = this.dragOffset.y,
                f = this.option("dragMinThreshold") || 0;
            Math.abs(u) < f && Math.abs(p) < f && ((a = r = 0), (l = c = 0)), this.applyChange({ panX: a, panY: r, friction: h }), this.emit("decel", l, c, u, p);
        }
        onWheel(t) {
        ...
        setTransform() {
            ...
            for (const i of k) {
                const n = "e" == i || "f" === i ? B : H;
                (s[i] = E(t[i], n)), Math.abs(e[i] - t[i]) < ("e" == i || "f" === i ? 0.51 : 0.001) && (this.current[i] = e[i]);
            }
        ...
        updateMetrics(t = !1) {
            ...
            this.containerRect = { width: c, height: h, innerWidth: c - u, innerHeight: h - d };
            ...
            let m = n.parentElement instanceof HTMLPictureElement ? n.parentElement : n;
            m = (this.option("transformParent") ? n.parentElement : null) || m;
            const g = m.getAttribute("style") || "";
            m.style.setProperty("transform", "none", "important"), s && ((m.style.width = ""), (m.style.height = "")), m.offsetHeight;
            ...
            if (
                ...
                let t = "";
                Math.abs(c - o) > 1 && (t += "x"), Math.abs(h - a) > 1 && (t += "y"), t && this.emit("refresh", t);
            }
            this.ignoreBounds ||
        ...
        applyChange({
            ...
            for (const t of k) ("a" != t && "d" != t) || !(m[t] > this.minScale + 1e-5 || m[t] < this.minScale - 1e-5) ? (this.target[t] = E(m[t], B)) : (this.target[t] = m[t]);
        ...
        fitY() {
            this.stop("target");
            const { containerRect: t, contentRect: e, target: i } = this;
            this.applyChange({ panX: 0.5 * t.width - (e.left + 0.5 * e.fitWidth) - i.e, panY: 0.5 * t.height - (e.top + 0.5 * e.fitHeight) - i.f, scale: t.height / e.fitHeight / this.targetScale, originX: 0, originY: 0, ignoreBounds: !0 });
        }
        toggleFS() {
            const { container: t } = this,
        ...
        zoomIn(t) {
            return new Promise((e, i) => {
                ...
                const { x: r, y: l, scale: c, opacity: h } = a,
                    d = () => {
                        t.state !== f.Closing && (h && (s.style.opacity = Math.max(Math.min(1, 1 - (1 - n.scale) / (1 - c)), 0) + ""), n.scale >= 1 && n.scale > n.targetScale - 0.1 && e(n));
                    },
                    u = (t) => {
                        t.scale < 0.99 || t.scale > 1.01 || ((s.style.opacity = ""), o.classList.remove("is-zooming-in"), t.off("endAnimation", u), t.off("touchStart", u), t.off("afterTransform", d), e(t));
                    };
                n.on("endAnimation", u),
                    n.on("touchStart", u),
    ...
    Object.defineProperty(Z, "defaults", { enumerable: !0, configurable: !0, writable: !0, value: { initialSize: "fit", Panzoom: { maxScale: 1 }, protected: !1, zoom: !0, zoomOpacity: "auto" } });
    const V = (t, e = {}) => {
        const i = new URL(t),
    ...
    Object.defineProperty(K, "defaults", { enumerable: !0, configurable: !0, writable: !0, value: U });
    class J extends v {
        constructor() {
            super(...arguments),
    ...
    Object.defineProperty(J, "defaults", { enumerable: !0, configurable: !0, writable: !0, value: { autoStart: !0, pauseOnHover: !0, progressParentEl: null, showProgress: !0, timeout: 3e3 } });
    class Q extends v {
        constructor() {
    ...
    class ct extends v {
        ...
        removeContainer() {
            ...
            e && e.removeEventListener("click", this.onClick, { passive: !1, capture: !0 }), null === (t = this.container) || void 0 === t || t.remove(), (this.container = null), (this.state = at.Disabled);
    ...
    class Et extends b {
        ...
        repositionSlides() {
            ...
            for (const t of this.slides)
                t.el
                    ? ("top" === s ? ((t.el.style.right = ""), (t.el.style.left = "")) : (t.el.style.top = ""), t.index !== o ? (t.el.style[s] = 0 === a ? "" : `${E(a, 1e3)}px`) : (t.el.style[s] = ""), (r += t.dim + t.gap), o++)
                    : (a += t.dim + t.gap);
            if (this.isInfinite && r)
                for (const i of this.slides)
                    i.el &&
                        (E(i.pos) < E(t) && E(i.pos + i.dim + i.gap) < E(l) && E(l) > E(e - t) && (i.el.style[s] = `${E(a + r, 1e3)}px`),
                            E(i.pos + i.gap) >= E(e - t) && E(i.pos) > E(l + t) && E(l) < E(t) && (i.el.style[s] = `-${E(r, 1e3)}px`));
            let c,
                h,
                d = [...this.inTransition];
            ...
            const r = (t, i, n) => {
                n && (n.remove(), (n = null)),
                    ...
                    (i.classList.add(a),
                        ...
                        (i.style.display = "")),
                    this.option("adaptiveHeight") && t.el && this.pages[this.page].slides.indexOf(t) > -1 && e.setViewportHeight();
            };
            for (const e of o) {
                let i = null;
        ...
        onDecel(t, e = 0, i = 0, n = 0, s = 0) {
            ...
            d
                ? this.onChange(f)
                : (Math.abs(h) > 5 ? ((this.pages.length < 3 || Math.max(Math.abs(n), Math.abs(s)) > this.pages[u].slides[0].dim) && (u = g), (u = o && a ? (h < 0 ? u - 1 : u + 1) : h < 0 ? u + 1 : u - 1)) : (u = g),
        ...
        slideTo(t = 0, { friction: e = this.option("friction"), transition: i = this.option("transition") } = {}) {
            ...
            (r *= this.isRTL && this.isHorizontal ? 1 : -1), Math.abs(n.target[o] - r) < 0.1 || (n.panTo({ x: this.isHorizontal ? r : 0, y: this.isHorizontal ? 0 : r, friction: e }), this.onChange(a, l));
        }
        slideToClosest(t) {
            if (this.panzoom) {
        ...
        updateMetrics() {
            ...
            for (const [t, e] of this.slides.entries()) {
                let n = 0,
                    o = 0;
                !e.el && i ? ((n = i.dim), (o = i.gap)) : (({ dim: n, gap: o } = this.getSlideMetrics(e)), (i = e)),
                    (n = E(n, 1e3)),
                    (o = E(o, 1e3)),
                    (e.dim = n),
                    (e.gap = o),
            ...
            (this.contentDim = s),
                t && ((t.contentRect[e] = s), (t.contentRect["e" === this.axis ? "fullWidth" : "fullHeight"] = s)),
                (this.pages = this.createPages()),
                (this.pages = this.processPages()),
                this.state === ft.Init && this.setInitialPage(),
                (this.page = Math.max(0, Math.min(this.page, this.pages.length - 1))),
                t && n === this.pages.length && s !== o && ((t.target[this.axis] = -1 * this.pages[this.page].pos), (t.current[this.axis] = -1 * this.pages[this.page].pos), t.stop()),
                this.manageSlideVisiblity(),
                this.emit("refresh");
        }
        getProgress(t, e = !1) {
    ...
    class It extends b {
        ...
        manageCaption(t) {
            ...
            if ((this.caption && this.stop(this.caption), a && this.caption && (this.caption.remove(), (this.caption = null)), o && !this.caption))
                for (const t of (null === (e = this.carousel) || void 0 === e ? void 0 : e.slides) || [])
                    t.captionEl && (t.captionEl.remove(), (t.captionEl = void 0), null === (i = t.el) || void 0 === i || i.classList.remove("has-caption"), null === (n = t.el) || void 0 === n || n.removeAttribute("aria-labelledby"));
        ...
        focus(t) {
            ...
            let u = null;
            t ? (!n || h.indexOf(n) < 0) && ((u = d || s), h.length && (i === Lt ? (u = h[0]) : (this.lastFocus !== s && i !== zt) || (u = h[h.length - 1]))) : (u = o && "image" === o.type ? s : d || s),
                u && c(u),
        ...
        setContent(t, e = "", i = !0) {
            ...
            o instanceof Element && t.filter && !t.error && (o = o.querySelector(t.filter)),
                o instanceof Element
                    ? (F(o, "fancybox__content"),
    ...
    Object.defineProperty(It, "version", { enumerable: !0, configurable: !0, writable: !0, value: "5.0.12" }),

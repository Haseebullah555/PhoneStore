...
$(document).ready(function () {
    $('#theme_direction').on('change', function (e) {
        var selectedOption = $(this).find('option:selected');
        var culture = selectedOption.data('culture');
        var returnUrl = '/';

        $.ajax({
            url: 'Language/SetLanguage',
            type: 'GET', // Use 'POST' if your action expects a POST request
            data: {
                culture: culture,
                returnUrl: returnUrl
            },

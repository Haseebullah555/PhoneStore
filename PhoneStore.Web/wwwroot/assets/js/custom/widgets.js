    ...
    init: function () {
        $.ajax({
            ...
            [].slice.call(t).map(function (e) {
                ...
                if (e) {
                    ...
                    new ApexCharts(e, {
                        ...
                        xaxis: {
                            categories: ["Feber", "Mar", "Apr", "May", "Jun", "Jul"],
                            axisBorder: { show: !1 },
                            axisTicks: { show: !1 },
                ...
                [].slice.call(e).map(function (e) {
                    ...
                    if (e) {
                        var a = e.getAttribute("data-kt-chart-color"),
                            ...
                            r = KTUtil.getCssVariableValue("--bs-light-" + a);
                        new ApexCharts(e, {
                            series: [{ name: "Net ", data: [40, 40, 30, 30, 35, 35, 50] }],
                            chart: { fontFamily: "inherit", type: "area", height: t, toolbar: { show: !1 }, zoom: { enabled: !1 }, sparkline: { enabled: !0 } },
                            plotOptions: {},
                            legend: { show: !1 },
                            dataLabels: { enabled: !1 },
            ...
            new ApexCharts(a, {
                    ...
                    series: [{ name: "Patients", data: patients }
                    ],
                    ...
                    (function () {
                        ...
                        e &&
                            new ApexCharts(e, {
                                series: [
                                    { name: "Net", data: [44, 55, 57, 56, 61, 58] },
                    ...
                    (function () {
                        ...
                        [].slice.call(t).map(function (t) {
                            ...
                            new ApexCharts(t, {
                                ...
                                xaxis: {
                                    labels: { show: !1 },
                                    categories: ["Jan", "Feb", "Mar", "Apr", "May", "Juna", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec", "Jan", "Feb", "Mar"],
                                    position: "top",
                                    axisBorder: { show: !1 },
                                    axisTicks: { show: !1 },
                                    crosshairs: { show: !1 },
